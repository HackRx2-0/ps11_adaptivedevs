  ...
  return (
    ...
    >
      ...
      <div className={'text-gray-700'}>
        <span>you can now consult your problem</span>
      </div>
    </div>
  );
};

const MsgFromDoctor: React.FunctionComponent<CustomChatInterface> = (
  props: CustomChatInterface
) => {
  return (
    <div className={'pl-3'}>
...
const MsgToDoctor: React.FunctionComponent<CustomChatInterface> = (
  props: CustomChatInterface
) => {
  return (
...
const ChatBody: React.FunctionComponent<CustomChatInterface> = (
  props: CustomChatInterface
) => {
